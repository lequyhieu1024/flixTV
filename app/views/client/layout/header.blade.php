			...
			<div class="col-12">
				<div class="header__content">
					...
					<a href="{{BASE_URL}}" class="header__logo">
						<img src="{{ IMG_URL }}logo.svg" alt="Movies & TV Shows, Online cinema HTML Template">
					</a>

					<ul class="header__nav">
						<li class="header__nav-item">
							<a class="header__nav-link" href="{{BASE_URL}}">Trang chủ </a>
						</li>
						
						<li class="header__nav-item">
							<a class="header__nav-link" href="#" role="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Thể loại <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

							<ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
								<li><a href="{{route('list-genres')}}">Tất cả thể loại </a></li>
								<li class="dropdown-submenu">
									<a class="dropdown-item" href="#" role="button" id="dropdownMenuSub" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Xem nhanh <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

									<ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenuSub">
										@foreach ($genres as $item)
											<li><a href="{{route('movies-by-genres/'.$item->id)}}">{{ $item->name }}</a></li>
										@endforeach
									</ul>
								</li>
								{{-- <li class="dropdown-submenu">
									<a class="dropdown-item" href="#" role="button" id="dropdownMenuSub" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Quốc gia <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

									<ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenuSub">
										<li><a href="category.html">Mỹ</a></li>
										<li><a href="category.html">Viễn tưởng</a></li>
										<li><a href="category.html">Tài liệu</a></li>
										<li><a href="category.html">Lãng mạn</a></li>
									</ul>
								</li> --}}
							</ul>
						</li>
						<li class="header__nav-item">
							<a class="header__nav-link header__nav-link--live" href="{{route('contact')}}">Liên hệ quảng cáo</a>
						</li>
						<li class="header__nav-item">
							...
							<ul class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="dropdownMenu3">
								...
								@if (isset($_SESSION['auth']) && $_SESSION['auth'] == 1)
									<li><a href="{{route('admin')}}" target="_blank">Trang quản trị viên</a></li>
								@endif
								<li><a href="{{route('privacy')}}">Chính cách quyền riêng tư</a></li>
								{{-- <li><a href="{{route('sign-in')}}">Đăng nhập</a></li>
								<li><a href="{{route('sign-up')}}">Đăng ký</a></li>
								<li><a href="{{route('forgot-password')}}">Quên mật khẩu</a></li>
					...
					<div class="header__actions">
						<form action="{{route('search')}}" method="POST" class="header__form">
							<input class="header__form-input" name="input_search" type="text" placeholder="Tìm kiếm...">
						...
						@if (isset($_SESSION['auth']))
							<a href="#modal-status" class="header__user main__table-btn main__table-btn--banned open-modal">
								<span>Đăng xuất</span>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20,12a1,1,0,0,0-1-1H11.41l2.3-2.29a1,1,0,1,0-1.42-1.42l-4,4a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l4,4a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L11.41,13H19A1,1,0,0,0,20,12ZM17,2H7A3,3,0,0,0,4,5V19a3,3,0,0,0,3,3H17a3,3,0,0,0,3-3V16a1,1,0,0,0-2,0v3a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V5A1,1,0,0,1,7,4H17a1,1,0,0,1,1,1V8a1,1,0,0,0,2,0V5A3,3,0,0,0,17,2Z"/></svg>
							</a>
						@else
							<a href="{{route('sign-in')}}" class="header__user">
								<span>Đăng nhập</span>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20,12a1,1,0,0,0-1-1H11.41l2.3-2.29a1,1,0,1,0-1.42-1.42l-4,4a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l4,4a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L11.41,13H19A1,1,0,0,0,20,12ZM17,2H7A3,3,0,0,0,4,5V19a3,3,0,0,0,3,3H17a3,3,0,0,0,3-3V16a1,1,0,0,0-2,0v3a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V5A1,1,0,0,1,7,4H17a1,1,0,0,1,1,1V8a1,1,0,0,0,2,0V5A3,3,0,0,0,17,2Z"/></svg>
							</a>
						@endif
...
<div id="modal-status" class="zoom-anim-dialog mfp-hide modal bg-info ">
	<h6 class="modal__title">Đăng xuất</h6>

	<p class="modal__text">Bạn có chắc chắn muốn đăng xuất ?</p>

	<div class="modal__btns">
		<button class="modal__btn modal__btn--apply btn-apply" type="button">Đồng ý</button>
