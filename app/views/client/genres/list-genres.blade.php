		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-xl-6">
					<h1 class="section__title section__title--head">Thể loại</h1>
				</div>
			...
			<div class="row row--grid">
				@foreach ($genres as $item)
					<div class="col-12 col-sm-6 col-lg-4 col-xl-3">
						<a href="{{route('movies-by-genres/'.$item->id)}}" class="category">
							<div class="category__cover">
								<img style="height: 180px" src="{{IMG_URL.'thumbnail/'.$item->thumbnail}}" alt="">
							</div>
