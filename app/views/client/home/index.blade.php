...
@section('content')
    <div class="home home--static">
		<div class="home__carousel owl-carousel" id="flixtv-hero">
			...
			<div style="height: 250px" class="home__card">
				<a href="{{route('detail/'.$item->id.'/'. convert_slug($item->title) )}}">
					<img src="{{IMG_URL.'thumbnail/'.$item->thumbnail_movie}}" alt="">
				</a>
				<div>
					<h2>{{$item->title}}</h2>
					<ul>
	...
	<div class="catalog">
		<div class="container">
				...
				<div class="col-12">
					<div class="catalog__nav">
						<div class="catalog__select-wrap">
							<select class="catalog__select" name="genres">
								...
								@foreach ($genres as $item)
									<option value="{{route('movies-by-genres/'.$item->id)}}">{{$item->name}}</option>
								@endforeach
							</select>
						...
						<div class="slider-radio">
							<input type="radio" name="grade" id="Featured" checked="checked"><label for="Featured">Newest</label>
							<input type="radio" name="grade" id="Popular"><label for="Popular">Viewest</label>
							<input type="radio" name="grade" id="Newest"><label for="Newest">Favourite</label>
						</div>
					</div>

						<div class="row change-content row--grid">
							{{-- @foreach ($moviesNewestLimit30 as $item)
							<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
								<div class="card">
									<a href="{{route('detail/'.$item->id.'/'. convert_slug($item->title) )}}" class="card__cover">
										<img style="height: 280px" src="{{IMG_URL.'thumbnail/'.$item->thumbnail_movie}}" alt="">
			...
			<div class="row">
				<div class="col-12">
					<button class="catalog__more load_more" type="button">Load more</button>
				</div>
			</div>
		</div>
	</div>
	...
	<section class="section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title">Thể loại phim</h2>
				</div>
				...
				<div class="col-12">
					<div class="section__carousel-wrap">
						...
						<div class="section__carousel owl-carousel" id="subscriptions">
							@foreach ($genres as $item)
							<div class="card">
								<a href="{{route('movies-by-genres/'.$item->id)}}" class="card__cover">
									<img style="height: 150px" src="{{IMG_URL.'thumbnail/'.$item->thumbnail}}" alt="">
								...
								<h3 class="card__title card__title--subs"><a href="{{route('movies-by-genres/'.$item->id)}}">{{ $item->name }}</a></h3>
	...
	<section class="section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><b>Flix</b>TV </h2>
					<p class="section__text">Đừng có đọc dòng này =))), đọc dòng này là phải share website cho bạn bè cùng xem ngay kkk !</p>
				</div>
					...
					<div class="section__carousel-wrap">
						<div class="section__interview owl-carousel" id="flixtv">
							<div class="interview">
								...
								<h3 class="interview__title"><a href="#">Phim được clone từ các website khác</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a href="#">Nếu vi phạm quyền riêng tư vui lòng liên hệ</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a href="#">Tôi chân thành xin lỗi về vấn đề này</a></h3>
							</div>
...
@endsection
@section('script')
	<script src="{{BASE_URL .'public/client/js/ajax-load-movies.js'}}"></script>
