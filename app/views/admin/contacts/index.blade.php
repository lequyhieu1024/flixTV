			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<span class="main__title-stat">Chưa phản hồi: {{!empty($count) ? $count : 0}} </span>
						...
						<table class="main__table">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="main__table-text"><a href="#">{{ $item->content }}</a></div>
									</td>
									<td>
										<div class="main__table-text"><a href="#">{{ $item->fullname }}</a></div>
									</td>
									<td>
										<div class="main__table-text"><a href="#">{{ $item->email }}</a></div>
									</td>
									<td>
											@if ($item->flag == 1)
									...
									<td>
										<div class="main__table-btns">
											@if ($item->flag == 0)
												<a href="{{ routeAdmin('contacts/update-flag/'.$item->id.'/'.$item->flag) }}" onclick="return confirm('Bạn có muốn thay đổi trạng thái?')" class="main__table-btn main__table-btn--banned">
											...
											{{-- <a href="{{ routeAdmin('contacts/edit/'.$item->id) }}" class="main__table-btn main__table-btn--edit">
												<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,7.24a1,1,0,0,0-.29-.71L17.47,2.29A1,1,0,0,0,16.76,2a1,1,0,0,0-.71.29L13.22,5.12h0L2.29,16.05a1,1,0,0,0-.29.71V21a1,1,0,0,0,1,1H7.24A1,1,0,0,0,8,21.71L18.87,10.78h0L21.71,8a1.19,1.19,0,0,0,.22-.33,1,1,0,0,0,0-.24.7.7,0,0,0,0-.14ZM6.83,20H4V17.17l9.93-9.93,2.83,2.83ZM18.17,8.66,15.34,5.83l1.42-1.41,2.82,2.82Z"/></svg>
											</a> --}}
											{{-- <a href="{{ routeAdmin('contacts/delete/'.$item->id) }}" onclick="return confirm('Bạn có muốn xóa không ?')" class="main__table-btn main__table-btn--delete">
...
@section('script')
	{{-- <script>
		...
		applyChange.addEventListener('click',() =>{
			...
			alert("{{ routeAdmin('contacts/update-flag/') }}"+ id+"/"+flag);
		})
