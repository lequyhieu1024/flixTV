				...
				<div class="col-12">
					<div class="main__table-wrap">
						<table class="main__table">
							<thead>
								<tr>
									<th class="col-2">Tập</th>
									<th class="col-3">Tên phim</th>
									<th class="col-4">Link tập phim</th>
									<th>ACTIONS</th>
								</tr>
							</thead>
							...
							<tbody>
								...
								<tr>
									<td>
										<div class="main__table-text">{{ $item->episode }}</div>
									</td>
									<td>
										<div class="main__table-text"><a href="#">{{ $item->title}}</a></div>
									</td>
									<td>
                                        <div class="main__table-text main__table-text--red">{{ $item->link }}</div>
									</td>
									<td>
										<div class="main__table-btns">
											...
											<a href="{{routeAdmin('links/edit/'.$item->link_id)}}" class="main__table-btn main__table-btn--edit">
												<button class="btn-edit" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,7.24a1,1,0,0,0-.29-.71L17.47,2.29A1,1,0,0,0,16.76,2a1,1,0,0,0-.71.29L13.22,5.12h0L2.29,16.05a1,1,0,0,0-.29.71V21a1,1,0,0,0,1,1H7.24A1,1,0,0,0,8,21.71L18.87,10.78h0L21.71,8a1.19,1.19,0,0,0,.22-.33,1,1,0,0,0,0-.24.7.7,0,0,0,0-.14ZM6.83,20H4V17.17l9.93-9.93,2.83,2.83ZM18.17,8.66,15.34,5.83l1.42-1.41,2.82,2.82Z"/></svg></button>
											</a>
											<a href="{{routeAdmin('links/delete/'.$item->link_id)}}" class="main__table-btn main__table-btn--delete">
												<button class="btn-del" onclick="return confirm('Bạn có muốn xóa không ?')"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10,18a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,10,18ZM20,6H16V5a3,3,0,0,0-3-3H11A3,3,0,0,0,8,5V6H4A1,1,0,0,0,4,8H5V19a3,3,0,0,0,3,3h8a3,3,0,0,0,3-3V8h1a1,1,0,0,0,0-2ZM10,5a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1V6H10Zm7,14a1,1,0,0,1-1,1H8a1,1,0,0,1-1-1V8H17Zm-3-1a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,14,18Z"/></svg></button>
											</a>
												<!-- modal delete -->
											{{-- <div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
                                                ...
                                                <div class="modal__btns">
                                                    <button class="modal__btn modal__btn--apply apply-del" data-id="{{$item->link_id}}" type="button">Xóa</button>
